			...
			<main className="max-w-6xl mx-auto px-4 py-10">
				{loading ? (
					<div className="flex flex-col items-center justify-center py-20">
						...
						<p className="text-gray-500 text-lg">Fetching restaurants...</p>
					</div>
						...
						{restaurants.map((r, i) => (
							...
							>
								<div className="p-6 flex flex-col h-full">
									...
									<p className="text-gray-600 text-sm mb-4 grow">{r.address}</p>

									<div className="mt-auto pt-4 border-t border-gray-50 flex items-center justify-between text-xs text-gray-400">
										<div className="flex flex-col">
											<span>Latitude: {r.coordinates.latitude.toFixed(4)}</span>
											<span>
												Longitude: {r.coordinates.longitude.toFixed(4)}
											</span>
										</div>
									</div>
								</div>
